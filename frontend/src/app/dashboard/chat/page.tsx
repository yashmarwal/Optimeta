...
const KNOWLEDGE_BASE = [
  ...
  {
    keywords: ['meta ad account setup', 'setup ad account', 'create ad account', 'create meta ad account', 'meta ads account', 'facebook ad account setup', 'how to create ad account', 'ad account create', 'setup meta account', 'meta account setup', 'facebook account setup', 'ads account setup', 'create facebook ad account', 'new ad account', 'open ad account'],
    answer: "Here's how to set up your Meta Ad Account step by step:\n\nSTEP 1 — Create Meta Business Suite\nGo to business.facebook.com\nClick \"Create Account\"\nEnter business name, your name, and business email.\nThis is your central hub for all Meta ads.\n\nSTEP 2 — Add Facebook Page\nSettings → Accounts → Pages → Add\nAdd your existing page or create a new one.\nA Facebook Page is required to run ads.\n\nSTEP 3 — Connect Instagram\nSettings → Accounts → Instagram Accounts\nConnect your Instagram Business profile.\nRequired for Instagram ad placements.\n\nSTEP 4 — Create Ad Account\nSettings → Accounts → Ad Accounts\nClick Add → Create a New Ad Account\nName it clearly (e.g. \"YourBrand Ads India\")\nSelect currency: INR ⚠️ Cannot change later\nSet timezone: India Standard Time (IST)\n\nSTEP 5 — Add Payment Method\nGo to Billing in your Ad Account\nClick Add Payment Method\nIndian options:\n- Credit/Debit card (Visa, Mastercard, RuPay)\n- Net banking\n- UPI via some cards\nTip: Use a business card for easy accounting.\nAdd a backup payment to prevent disruption.\n\nSTEP 6 — Install Meta Pixel\nEvents Manager → Connect Data Sources → Web\nChoose Meta Pixel → Get Started\nInstall code on your website <head> section\nFor Shopify: Use Meta Sales Channel app\nVerify with Meta Pixel Helper Chrome extension\n\nSTEP 7 — Set Up Conversions API\nEvents Manager → Settings → Conversions API\nCritical for accurate iOS tracking\nFor Shopify: Included in Meta Sales Channel\nEvent Match Quality should be above 6\n\nSTEP 8 — Generate Your Campaign Blueprint\nUse Optimeta to get your complete campaign strategy before spending ₹1 on ads.\n\nSTEP 9 — Create Your First Campaign\nGo to adsmanager.facebook.com\nClick Create → Select objective\nFollow your Optimeta blueprint exactly\n\nTotal setup time: 2-4 hours first time.\nDo NOT skip Steps 6 and 7 — most Indian brands do and then wonder why results are poor.",
  },
  {
    keywords: ['business manager setup', 'meta business manager', 'create business manager', 'setup business manager', 'business suite setup', 'create business suite', 'meta business suite setup'],
    answer: 'How to set up Meta Business Suite:\n\n1. Go to business.facebook.com\n2. Click "Create Account"\n3. Enter:\n   • Business name\n   • Your full name\n   • Business email (not Gmail ideally)\n4. Verify your email\n5. Add your Facebook Page\n6. Add your Instagram account\n7. Enable Two-Factor Authentication immediately\n   Settings → Security Center → 2FA\n\nWhy you need Business Suite:\n- Manage ads separately from personal account\n- Add team members with different roles\n- Keep business assets organized\n- Access Events Manager and Commerce Manager\n- Required for proper ad account setup\n\nBusiness Suite is free and takes less than 15 minutes to set up.',
  },
  {
    keywords: ['add payment meta', 'payment method facebook ads', 'billing meta ads', 'add card meta ads', 'razorpay meta ads', 'upi facebook ads', 'payment facebook', 'add billing meta'],
    answer: 'How to add payment method to Meta Ads:\n\n1. Go to Ads Manager\n2. Click the menu (≡) → Billing\n3. Click "Add Payment Method"\n\nAvailable in India:\n✅ Credit card (Visa, Mastercard, RuPay)\n✅ Debit card (some banks)\n✅ Net banking (selected banks)\n✅ UPI (via some card integrations)\n\nTips for Indian brands:\n- Use a credit card for 30-day float period\n- Add a backup payment to prevent campaign pause\n- Meta charges in INR — no forex fees\n- Minimum charge threshold: ₹700 or your set limit\n\nNew account spending limits:\nNew accounts start with lower daily limits.\nMeta increases these automatically as you build a payment history over 2-4 weeks.\nStart slow — ₹500-1000/day first week.',
  },
  {
    keywords: ['account disabled', 'ad account banned', 'ads disabled', 'account restricted', 'meta account disabled', 'facebook ads banned', 'why is my account disabled', 'ad account blocked'],
    answer: 'If your Meta Ad Account is disabled:\n\nSTEP 1 — Check why\nGo to Account Quality in Business Suite\nRead the policy violation listed\nCheck email from Meta for details\n\nSTEP 2 — Request Review\nIn Account Quality click "Request Review"\nWrite a clear, polite appeal\nExplain your business and ad content\nWait 24-48 hours\n\nCommon reasons in India:\n- Payment failure (most common)\n- Policy violation in ad creative\n- Suspicious login or account activity\n- New account scaling budget too fast\n- Restricted content (loans, crypto, weight loss claims, MLM)\n\nPrevention tips:\n- Warm up new accounts slowly\n  Week 1: ₹200-500/day max\n  Week 2: ₹500-1000/day\n  Week 3+: Scale gradually\n- Never use misleading claims in ads\n- Keep payment method updated\n- Don\'t log in from multiple IPs\n- Don\'t edit campaigns too frequently\n\nIf review is rejected:\nCreate a new Business Manager account\nUse a different email and payment method\nWarm up carefully from the start',
  },
  {
    keywords: ['verify domain', 'domain verification meta', 'facebook domain verify', 'verify website meta', 'domain verification facebook'],
    answer: 'How to verify your domain on Meta:\n\nWhy verify?\nRequired for iOS 14+ tracking accuracy.\nLets you configure 8 conversion events.\nImproves ad delivery and ROAS.\n\nSteps:\n1. Go to Business Suite → Brand Safety → Domains\n2. Click Add → Enter your domain\n3. Choose verification method:\n\nMethod A — HTML file (easiest):\nDownload the HTML file\nUpload to your website root folder\nExample: yoursite.com/facebook-domain-verify.html\n\nMethod B — DNS TXT record:\nAdd TXT record in your domain DNS settings\nName: @ (or leave blank)\nValue: facebook-domain-verify=xxxxx\nWait 24-48 hours for DNS propagation\n\nMethod C — Meta tag:\nAdd the meta tag to your website <head>\n\n4. Click Verify\n\nAfter verification:\nGo to Events Manager → Web Events Configuration\nPrioritize your 8 most important events\n(Purchase, AddToCart, ViewContent etc)\n\nMost Indian brands skip domain verification.\nIt directly impacts your campaign performance.',
  },
];
